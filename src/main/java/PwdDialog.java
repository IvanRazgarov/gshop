 ...
 * @author Willy
 */
public class PwdDialog extends javax.swing.JDialog {
...
//        logonData.passw = pwdField.getPassword().toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PwdDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PwdDialog dialog = new PwdDialog(new javax.swing.JFrame(), true);
